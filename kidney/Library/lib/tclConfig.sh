...
# installed.
TCL_PREFIX='D:/kidney_disease_classification/kidney_disease_classification/kidney\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/kidney_disease_classification/kidney_disease_classification/kidney\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/kidney_disease_classification/kidney_disease_classification/kidney\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/kidney_disease_classification/kidney_disease_classification/kidney\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/kidney_disease_classification/kidney_disease_classification/kidney\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/kidney_disease_classification/kidney_disease_classification/kidney\Library\lib\tclstub86.lib'
